...
#define DHT_INPUTPIN2 PC4
#define DHT_INPUTPIN3 PC5
...
extern int8_t dht_gettemperaturehumidity(float *temperature, float *humidity, int8_t sensor);
#elif DHT_FLOAT == 0
extern int8_t dht_gettemperature(int8_t *temperature);
extern int8_t dht_gethumidity(int8_t *humidity);
extern int8_t dht_gettemperaturehumidity(int8_t *temperature, int8_t *humidity, int8_t sensor);
#endif
